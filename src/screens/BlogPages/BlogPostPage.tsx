      ...
      >
        ...
        >
          ...
          <main className="flex-1 max-w-full md:max-w-[60vw]">
            ...
            {/* Post Content */}
            <motion.div
              className="prose prose-lg max-w-none md:w-[86%] text-[4.20vw] flex flex-col gap-[6vw] md:block md:text-[1.1vw] text-gray-700 leading-relaxed"
              style={{
                lineHeight: '1.8'
              }}
                ...
                >
                  {relatedPosts.map((relatedPost, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 conteudoRelacionado">
                        ...
                        <p className="text-gray-600 text-[3.8vw] md:text-[0.9vw] leading-relaxed line-clamp-2">
                          ...
                          <span dangerouslySetInnerHTML={{ __html: relatedPost.excerpt.rendered }} />
                        </p>
