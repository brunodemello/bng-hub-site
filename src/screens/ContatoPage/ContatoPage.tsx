        ...
        <div className="container mx-auto max-w-[79.33vw] mt-[5vw]">
          <div className="flex gap-[0] items-start">
            ...
            >
              ...
              <motion.h1 
                className="font-semibold text-[#212121] text-[2.22vw] leading-[2.78vw] mb-[1vw] mt-[1.5vw]"
              ...
              >
                <div className="space-y-[1.39vw] text-[#666666] text-[1.1vw] font-normal tracking-[0] leading-[1.73]">
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <motion.div 
              className="flex-1 max-w-[33.33vw] w-[32.375vw] h-[36.806vw]"
              initial={{ x: 50, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              ...
              >
                ...
                <CardContent className="p-0 w-[82%]">
                  ...
                  >
                    ...
                    >
                      <label className="block text-white text-[0.83vw] font-medium mb-[0.42vw]">
                        Nome
                      </label>
                      <Input
                        type="text"
                        ...
                        placeholder="Nome*"
                        required
                        className="w-full px-[1.11vw] py-[0.69vw] border-none rounded-[0.42vw] text-[0.83vw] bg-white text-gray-700 placeholder-gray-400 h-[2.153vw]"
                      />
                    </motion.div>
                    ...
                    >
                      ...
                      <Input
                        ...
                        placeholder="E-mail*"
                        required
                        className="w-full px-[1.11vw] py-[0.69vw] border-none rounded-[0.42vw] text-[0.83vw] bg-white text-gray-700 placeholder-gray-400 h-[2.15vw]"
                      />
                    </motion.div>
                    ...
                    >
                      ...
                      <textarea
                        ...
                        required
                        rows={4}
                        className="w-full px-[1.11vw] py-[0.69vw] border-none rounded-[0.42vw] text-[0.83vw] bg-white text-gray-700 placeholder-gray-400 resize-vertical min-h-[6.94vw]"
                      />
                    </motion.div>

                    {/* Checkbox Privacidade */}
                    <motion.div 
                      className="flex items-start gap-[0.69vw] pt-[0.69vw]"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      <input
                        ...
                        onChange={handleInputChange}
                        required
                        className="mt-[0.14vw] w-[1.11vw] h-[1.11vw] accent-[#fedc0b]"
                      />
                      <label className="text-white text-[0.69vw] leading-[1.63]">
          ...
          >
            ...
            <motion.div 
              className="flex-1 max-w-[36.11vw]"
            ...
            >
              ...
              >
                ...
                <motion.div 
                  className="absolute bottom-[1.39vw] right-[1.39vw] bg-white rounded-[0.69vw] p-[1.11vw] shadow-lg max-w-[13.89vw]"
                ...
                >
                  <div className="flex items-center gap-[0.42vw] mb-[0.42vw]">
                    ...
                    <span className="font-bold text-[0.83vw] text-gray-800">BNG Hub</span>
                  </div>
