      ...
      <div className="pessoas-content" style={{ paddingTop: '120px' }}>
        <section className="carreira !mt-[2.20vw]" data-aos="fade-up" data-aos-duration="3000">
          <div className="carreira__imgWrapper">
            <img src="/secao-carreira.jpeg" alt="Imagem da seção carreira" className="w-full h-full object-cover object-center rounded-[16px]" />
          ...
          <div className="nossa-cultura__vantagens hidden md:flex">
            <div className="vantagem__card" data-aos="fade-up">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_01.svg" alt="" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="vantagem__card" data-aos="fade-down">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_02.svg" alt="" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="vantagem__card" data-aos="fade-up">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_03.svg" alt="" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="vantagem__card" data-aos="fade-down">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_04.svg" alt="" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="vantagem__card" data-aos="fade-up">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_05.svg" alt="" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="vantagem__card" data-aos="fade-down">
              <div className="card__imgWrapper">
                <img src="/icon_cultura_06.svg" alt="" className="w-full h-full object-contain" />
              </div>
        ...
        <section ref={counterSectionRef} className="time">
          ...
          <div className="time__imgWrapper">
            <img src="/pessoasUpscaled.png" alt="Imagem do time reunido" className="w-full h-full object-cover object-center rounded-lg" />
          </div>
        </section>
        ...
        <section className="cultura-cards" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
          ...
          <div className="cultura__cards-container">
            <div className="card-main" data-aos="flip-right">
              ...
              <div className="card__imgWrapper">
                <img src="/card-cultura-01.png" alt="" className="w-full h-full object-cover object-center" />
              </div>
            ...
            <div className="card-main" data-aos="flip-right">
              ...
              <div className="card__imgWrapper">
                <img src="/card-cultura-02.png" alt="" className="w-full h-full object-cover object-center" />
              </div>
              <div className="icone-virar">
                <svg width="34" height="29" viewBox="0 0 34 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="card-main" data-aos="flip-right">
              ...
              <div className="card__imgWrapper">
                <img src="/card-cultura-03.png" alt="" className="w-full h-full object-cover object-center" />
              </div>
              <div className="icone-virar">
                <svg width="34" height="29" viewBox="0 0 34 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24.7278 23.9472H17.0005C16.1474 23.9472 15.4551 23.2533 15.4551 22.3984C15.4551 21.5435 16.1474 20.8497 17.0005 20.8497H24.7278C25.5809 20.8497 26.2732 21.5435 26.2732 22.3984C26.2732 23.2533 25.5809 23.9472 24.7278 23.9472Z" fill="#00009B" />
        ...
        <section className="trabalhe-conosco" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
          <div className="carreira__content">
            ...
            <p className="conteudo-mobile">Se você quer fazer parte de um
              ecossistema que valoriza o <br />
              desenvolvimento contínuo, o <br />
              trabalho em equipe e o impacto <br />
              positivo na vida de milhares de <br />
              brasileiros todos os dias, preencha <br />
              o formulário abaixo e envie seu <br />
              currículo.
            </p>
          </div>
          <form id="trabalhe-conosco" className="trabalhe-conosco__form" onSubmit={handleSubmit}>
